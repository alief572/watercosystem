...
class Master_rate extends Admin_Controller
{
	//Permission
	...
	public function index()
	{
		...
		$this->template->title('Master Rate Non Ferreous');
	...
	public function SaveEditRate()
	{
		...
		$this->db->where('id_rate', $id)->update("ms_rate", $data);
