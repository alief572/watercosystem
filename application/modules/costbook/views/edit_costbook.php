...
foreach ($results['costbook'] as $costbook){
}	
					...
					<div class="col-md-12">
						<div class="form-group row">
							<div class="col-md-2">
							 ...
							 <div class="col-md-6">
							 <input type="hidden" class="form-control" id="id" required name="id" placeholder="id" value="<?=$costbook->id?>">
...
<script type="text/javascript">
	...
	$(document).on('submit', '#data_form', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'costbook/saveEditCostbook',
			  dataType : "json",
			  data:data,
