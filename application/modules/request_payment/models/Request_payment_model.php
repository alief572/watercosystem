...
class Request_payment_model extends BF_Model
{
    ...
    {
        $data    = $this->db->query("SELECT nomor,tanggal,tipe,no_reff,keterangan,stspos,sum(kredit) as total FROM " . DBERP . ".jurnal WHERE jenis_jurnal='BUK030' group by nomor order by nomor desc")->result();
        return $data;
    }
}
