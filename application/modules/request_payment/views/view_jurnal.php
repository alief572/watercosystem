...
<div class="tab-content">
	<div class="tab-pane active">
		<div class="box box-primary">
			<div class="box-header">
				<div class="form-group ">
					...
					<div class="col-sm-4">
						<input type="date" id="tanggal" name="tanggal" value="" class="form-control" tabindex="-1">
					</div>
				</div>
			</div>
		...
		foreach($data AS $record){ 
			...
			$sum_debet	+= $record->debet;
			$sum_kredit	+= $record->kredit;

			$format_debet = number_format($record->debet, 0, ',', '.');
			$format_kredit = number_format($record->kredit, 0, ',', '.');
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="keterangan<?=$numb?>" name="keterangan[]" value="<?=$info->informasi;?>"></td>
