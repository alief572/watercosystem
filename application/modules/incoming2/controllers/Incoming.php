...
class Incoming extends Admin_Controller
{
	...
	public function SaveNew()
	{
		...
		foreach ($Detail as $val => $valx) {
			...
			foreach ($valx['detail'] as $val2 => $valx2) {
				...
				$totalnilai  = ($nilai_kurs * $hargasatuan) * $qtydo;
				...
				$this->kartu_stok_in($material, $qtydo, $notr, $totalnilai);
			}
			foreach ($valx['detail'] as $val2 => $valx2) {
	...
	public function kartu_stok_in($material, $qtyso, $notr, $totalnilaido)
	{
