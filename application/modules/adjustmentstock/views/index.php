							...
							foreach ($results['stok'] as $record) {
								...
								<tr>
									...
									<td style="padding-left:20px">
										<?php if ($ENABLE_VIEW) : ?>
											<a class="btn btn-primary btn-sm edit" href="javascript:void(0)" title="Add Adjustment" data-id_inventory3="<?= $record->id_category3 ?>" data-id_stock="<?= $record->id_stock ?>"><i class="fa fa-edit"></i></a>
										<?php endif; ?>
									</td>
...
<script type="text/javascript">
	$(document).on('click', '.edit', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'adjustmentstock/AdjustNow/' + id + '/' + idstock,
	...
	$(function() {
		...
		var table = $('#exampleaa').DataTable({
			ajax: {
				url: siteurl + active_controller + 'get_data_adjustment_stock',
				type: "POST",
				dataType: "JSON",
				data: function(d) {
