...
<body>
	...
	$dp = $this->db->query("SELECT * FROM wt_plan_tagih WHERE no_so='$header->no_so' AND keterangan='dp' AND status_invoice='1'")->row();
			...
			<td width="350" align="left">
				<table>
					...
					<tr>
						<td align='left'>No</td>
						<td align='left'>:</td>
						<td align='left'><?= $header->no_surat ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
						<td align='left'>Your Reff.</td>
						<td align='left'>:</td>
						<td align='left'><?= $header->referensi ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
						...
						<td align='left'>:</td>
						<td align='left'><?= $header->nama_sales ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
						<td align='left'>Term Of Payment.</td>
						<td align='left'>:</td>
						<td align='left'><?= $top->nama_top ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
						<td align='left'>Tgl Jatuh Tempo.</td>
						<td align='left'>:</td>
						<td align='left'><?= date('d-F-Y', strtotime($header->jatuh_tempo)) ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
						...
						<td align='left'>:</td>
						<td align='left'><?= $header->no_faktur ?></td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<table id="tables" border="0" width='100%' align="left">
		<thead>
			<tr height='60'>
				...
				<th align="center" width="60">Nilai <br> Diskon</th>
		...
		<tfoot>
			...
			<?php if (!empty($dp2->nilai_invoice)  && $header->payment != 'Payment II') { ?>
				<tr>
					<th align="right" colspan='6' width="300" align='right'><?= $dp2->payment ?></th>
		...
		<tr>
			...
			<td width="350" align="left" border='0.5'>
				<table>
					...
					<tr>
						<td align='left'>&#61;&#62;Barang Kena Pajak</td>
					</tr>
					<tr>
						<td align='left'>&#61;&#62;Barang Yang sudah dibeli tidak bisa ditukar/dikembalikan</td>
					</tr>
					<tr>
						<td align='left'>&#61;&#62;Kwitansi ini dianggap sah bila ada pembayaran</td>
					</tr>
					<tr>
						<td align='left'>&#61;&#62;Pembayaran dapat dilakukan dengan transfer/setoran tunai melalui bank</td>
					</tr>
					<tr>
						<td align='left'>&#61;&#62;Apabila sudah transfer/setor tunai diharapkan konfirmasi/fax bukti transfer</td>
					</tr>
					<tr>
						<td align='left'>&#61;&#62;Faktur pajak dikirimkan bulan berikutnya via email setiap tanggal 10</td>
					</tr>
				</table>
			</td>
			<td width="100" align="left" border='0.5'>
				<table>
					<tr>
						<td align='left'>Pembayaran dilakukan melalui rekening :</td>
					</tr>
					<tr>
						<td align='left'><b>CIMB Niaga cabang kelapa gading</b></td>
					</tr>
					<tr>
						<td align='left'><b>No A/C. 8000-9570-4600(IDR)</b></td>
					</tr>
					<tr>
						<td align='left'>&nbsp;</td>
					</tr>
					<tr>
						<td align='left'><b>BCA cabang kelapa gading square</b></td>
					</tr>
					<tr>
						<td align='left'><b>No A/C. 870-003-599-0(IDR)</b></td>
					</tr>
					<tr>
						<td align='left'><b>On Behalf PT. WATERCO INDONESIA</b></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td width="350" align="left" border='0'>
				<table>
					...
					<tr>
						<td align='left' width="300"><?= $header->note ?></td>
					</tr>
					<tr>
						<td align='left'>&nbsp;</td>
					</tr>
