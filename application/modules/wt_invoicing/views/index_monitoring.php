			...
			<tbody>
				<?php if (empty($results)) {
					...
					foreach ($results as $record) {
						...
						$tgl_terima = (!empty($record->tgl_invoice)) ? date('d-F-Y', strtotime($record->tgl_invoice)) : '-';
				...
				?>
						<tr>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($ENABLE_MANAGE) : ?>
									<a class="btn btn-success btn-sm" href="<?= base_url('/wt_invoicing/FollowUp/' . $record->no_invoice) ?>" title="Follow UP" data-no_inquiry=""><i class="fa fa-check"></i>
									</a>
								<?php endif; ?>
								<?php if ($ENABLE_MANAGE) : ?>
