		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="text" class="form-control" id="reff" required name="reff" readonly placeholder="Reff" value="<?= $hdso->reff?>">
			        </div>
		        </div>
		    </div>
		    <div class="col-sm-6">
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
					<textarea class="form-control" id="note" required name="note" placeholder="Note"></textarea>
			        </div>
		        </div>
		    </div>
		</div>
						...
						<table id="example1" class="table table-bordered table-striped">
									...
									foreach ($results['detail'] as $dt_spk){
										...
										$nilai_diskon = round($dt_spk->nilai_diskon);
                                        ...
                                        echo	"</select>
											...
											<td id='date_$loop'><input type='date' class='form-control input-sm' id='used_date_$loop' required name='dt[$loop][date]'  value='$dt_spk->tgl_delivery' readonly></td>
                                         	<td id='qty_so_$loop'><input type='text' class='form-control input-sm' id='used_qty_so_$loop' required name='dt[$loop][qty_so]' onblur='HitungTotal($loop)' value='$dt_spk->qty_delivery' readonly></td>
                                            ...
                                            <td id='nilai_diskon_$loop'><input type='text' value='$nilai_diskon' class='form-control'  id='used_nilai_diskon_$loop' required name='dt[$loop][nilai_diskon]' readonly></td>
                                            ...
                                            <td id='total_harga_$loop'><input type='text' value='$total' class='form-control input-sm total' id='used_total_harga_$loop' required name='dt[$loop][total_harga]' readonly></td>
									...
									<tfoot>
									    <tr>
											...
											<th width='7%'></th>                                            
                                            <th width='7%'><input type='text' class='form-control' id='totalproduk'  name='totalproduk' readonly value="<?= number_format($totalharga)?>" ></th>										
										...
										<tr>
											...
											<th width='7%'></th>                                            
                                            <th width='7%'><input type='text' class='form-control diskon' id='diskon'  name='diskon' readonly value="<?= number_format($diskon)?>" ></th>										
										...
										<tr>
											...
											<th width='7%'></th>                                            
                                            <th width='7%'><input type='text' class='form-control totalproduk' id='total'  name='total' readonly value="<?= number_format($tagih)?>" ></th>										
...
function DelItem(id){
	...
	function Freight(id)
		...
		$('#grandtotal').val(number_format(nilai_tagih));	
		$('#dpp').val(number_format(nilai_tagih));	
		
		$('#totalppn').val(number_format(nilai_ppn));

		$('#nilai_tagih').val(number_format(nilai_invoice));	
