...
function AddMaterial()
    {
		...
		foreach ($material as $material){
			...
			echo"<option value='$material->id_category3'>$material->nama</option>";
...
function cari_inven1()
	...
	public function SaveNew()
    {
		...
		$numb1++;
		$materials = $this->db->query("SELECT a.* FROM ms_inventory_category3 a WHERE a.id_category3 = '".$used[idmaterial]."' AND a.deleted = '0'  ")->row();
		            $dt =  array(
							'no_pr'					=> $code,
							'id_dt_pr'				=> $code.'-'.$numb1,
