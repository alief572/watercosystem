				...
				<table>
					<tr>
						<?php if ($header->no_revisi != null) { ?>
							<td align='left'>No</td>
							<td align='left'>:</td>
							<td align='left'><?= $header->no_revisi ?></td>
						<?php } else { ?>
							<td align='left'>No</td>
							<td align='left'>:</td>
					...
					<tr>
						...
						<td align='left'>:</td>
						<td align='left'>Penawaran Produk Waterco</td>
					</tr>
					<?php if ($header->revisi != '0') { ?>
						<tr>
							<td align='left'>Revisi</td>
							<td align='left'>:</td>
							<td align='left'><?= $header->revisi ?></td>
						</tr>
					<?php } ?>
				</table>
			</td>
		...
		<tr>
			...
			<td width="350" align="left"><br><br>
				<table>
					...
					<tr>
						<td align='left'><?= $customer->name_customer ?></td>
					</tr>
					<tr>
						<td align='left'>UP.&nbsp; Bpk/Ibu.&nbsp;<?= $header->pic_customer ?></td>
					</tr>
					<tr>
						<td align='left' width="250"><?= $customer->address_office ?></td>
					</tr>
					<tr>
						<td align='left'><?= $customer->zip_code ?></td>
					</tr>
				</table>
				<br><br>
				<table>
					<tr>
						<td align='left'>Dengan Hormat,</td>
					</tr>
					<tr>
						<td align='left'></td>
					</tr>
					...
					<tr>
						<td align='left'>Berikut kami sampaikan penawaran produk waterco sesuai dengan spek yang Bpk/Ibu minta. </td>
					</tr>
					<tr>
						<td align='left'></td>
					</tr>
			...
			<td width="350" align="left"><br><br>
				<table>
					<?php if ($header->id_customer == 'MC2200277') { ?>
						...
						<tr>
							<td align='right'>&#61;&#62;</td>
							<td>Harga Franco Jakarta</td>
						</tr>
						<tr>
							<td align='right'>&#61;&#62;</td>
							<td>No. Rek PT. Waterco Indonesia BCA A/C 87000.35.990, CIMB Niaga A/C 800095704600</td>
						</tr>
						<tr>
							<td align='right'>&#61;&#62;</td>
							<td>Pembayaran I : DP 80% <br> Pembayaran II: 20%</td>
						</tr>
						<tr>
							<td align='right'>&#61;&#62;</td>
							<td>Penjualan unit waterco tidak termasuk supervisi dan testing & commissioning</td>
						</tr>
						<tr>
							<td align='right'>&#61;&#62;</td>
							<td>Penawaran berlaku 1 bulan</td>
						</tr>
						<tr>
							<td align='right'>&#61;&#62;</td>
				...
				<table>
					<tr>
						<td align='left'>Demikian penawaran kami, atas perhatian kami ucapkan terima kasih. </td>
					</tr>
					<tr>
						<td align='left'></td>
					</tr>
		...
		<tr>
			...
			<td width="250" align="left"><br><br>
				<table>
					...
					<tr>
						<td align='center'><u><?= $header->nama_sales ?></u> </td>
					</tr>
					<tr>
						<td align='center'><?= $sales->nohp ?></td>
					</tr>
				</table>
			</td>
			<td width="230" align="left"><br><br>
				<?php if ($header->approved_by != null) { ?>
					<table>
						...
						<tr>
							<td align='center'><u>Fajar Nugroho Widyanto</u></td>
						</tr>
						<tr>
			...
			<td width="250" align="left"><br><br>
				<table>
					...
					<tr>
						<td align='center'><?= $customer->name_customer ?></td>
					</tr>
				</table>
			</td>
		</tr>
