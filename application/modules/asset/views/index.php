	...
	<div class="box"> 
		<div class="box-header">
			...
			<div class="box-tool pull-left"> 
				...
				<select id='kategory' name='kategory' class='form-control input-sm chosen-container' style='min-width:150px; float:left; margin-bottom: 5px;'>
			...
			<table id="example1" class="table table-bordered table-striped" width='100%'>
				<thead>
					<tr class='bg-blue' >
						...
						<th class="text-center">Periode&nbsp;Jurnal</th>
