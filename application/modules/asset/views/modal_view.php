...
$selx = $dataD[0]['lokasi_asset'];

$msaset  = $this->db->query("SELECT * FROM divisi WHERE id_divisi='$selx'")->row();
...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class='form-group row'>		 	 
			<label class='label-control col-sm-2'><b>Lokasi Asset <span class='text-red'>*</span></b></label>
			<div class='col-sm-4'> 
					<?php
						echo form_input(array('id'=>'lokasi_asset','name'=>'lokasi_asset','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nama Asset', 'value'=>$msaset->nm_divisi, 'readonly'=>'readonly'));											
					?>	
