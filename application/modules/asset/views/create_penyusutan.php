                ...
                <div class="box-body">
					...
					<div class="form-group ">
						...
						<div class="col-sm-3">
								...
								echo form_dropdown('id_aset',$dataaset, set_value('id_aset', isset($data->id_aset) ? $data->id_aset: '0'), array('id'=>'id_aset','class'=>'form-control','required'=>'required', 'onchange'=>'get_budget()'));
								?>
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-3">
							<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<input type="text" class="form-control divide" id="budget_sisa" name="budget_sisa" value="<?php echo set_value('budget_sisa', isset($data->budget_sisa) ? $data->budget_sisa: 0); ?>" placeholder="0" required readonly tabindex="-1">
							</div>
						</div>
					</div>
					<div class="form-group ">
						...
						<label for="no_coa" class="col-sm-2 control-label">Tipe PR<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-3">
							<div class="input-group">
							<?php if(isset($data->nilai_pr)){?>
								<input type="text" class="form-control" id="tipe_pr" name="tipe_pr" value="<?php echo $data->tipe_pr ?>" readonly>
							<?php } else { ?>
								<?php
								echo form_dropdown('tipe_pr',$dattipe_pr, set_value('tipe_pr', isset($data->tipe_pr) ? $data->tipe_pr: '0'), array('id'=>'tipe_pr','class'=>'form-control','required'=>'required', 'onchange'=>'show_dtl()'));
								?>
							<?php } ?>
							</div>
						</div>
