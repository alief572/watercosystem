...
<?php
		...
		$no_pr  = $data->no_pr;
		$idaset	= $data->id_aset;
		$search  = $this->db->query("SELECT * FROM tr_po_aset WHERE no_pr='$no_pr'")->row();
...
<div class="box box-primary">
	...
	<div class="box-body">
		<div class='form-group row'>		 	 
			<label class='label-control col-sm-2'><b>No PR <span class='text-red'>*</span></b></label>
			<div class='col-sm-4'>             
			...
			<label for="id_aset" class="col-sm-2 control-label">COA<font size="4" color="red"><B>*</B></font></label>
			<div class="col-sm-4">
					<?php
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>             
					<?php
						echo form_input(array('id'=>'nm_asset','name'=>'nm_asset','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nama Asset', 'value'=>$msaset->nama_aset));											
					    echo form_input(array('type'=>'hidden','id'=>'coa','name'=>'coa','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nama Asset', 'value'=>$msaset->coa));											
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'> 
				<?php
					$dataaset[0]	= 'Select An Option';
					echo form_dropdown('lokasi_asset',$datdivisi, set_value('lokasi_asset', isset($msaset->divisi) ? $msaset->divisi: '0'), array('id'=>'lokasi_asset','class'=>'form-control','required'=>'required','readonly'=>readonly));
					?>
			</div>
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>             
					<?php
						echo form_input(array('id'=>'nilai_asset','name'=>'nilai_asset','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Nilai Asset','data-decimal'=>'.','data-thousand'=>'','data-precision'=>'0','data-allow-zero'=>false, 'value'=>$search->harga_satuan, 'readonly'=>readonly));											
					?>		
			</div>
			<label class='label-control col-sm-2'><b>Qty <span class='text-red'>*</span></b></label>
			<div class='col-sm-4'>            
					<?php
						echo form_input(array('id'=>'qty','name'=>'qty','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Qty Assets','data-decimal'=>'.','data-thousand'=>'','data-precision'=>'0','data-allow-zero'=>false, 'value'=>$search->qty, 'readonly'=>readonly));											
					?>		
			</div>
		</div>
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>             
				<?php 
					echo form_input(array('id'=>'tanggal','name'=>'tanggal','class'=>'form-control input-md','autocomplete'=>'off','placeholder'=>'Tanggal', 'readonly'=>'readonly', 'value'=>$search->tgl_po));											
				?>
			</div>
		</div>
