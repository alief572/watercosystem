...
{
	//Permission
	protected $viewPermission 	= 'Inventory_2.View';
	protected $addPermission  	= 'Inventory_2.Add';
	protected $managePermission = 'Inventory_2.Manage';
	protected $deletePermission = 'Inventory_2.Delete';
