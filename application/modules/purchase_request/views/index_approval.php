<?php
    $ENABLE_ADD     = has_permission('Purchase_Request_Approval.Add');
    $ENABLE_MANAGE  = has_permission('Purchase_Request_Approval.Manage');
    $ENABLE_VIEW    = has_permission('Purchase_Request_Approval.View');
    $ENABLE_DELETE  = has_permission('Purchase_Request_Approval.Delete');
