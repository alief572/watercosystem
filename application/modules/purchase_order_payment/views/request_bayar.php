 ...
 <div class="box box-primary">
    <div class="box-body">
        ...
        <div class="col-sm-12">
		    ...
		    <center>
		    <button type="submit" class="btn btn-success btn-sm" name="save" id="simpan-com"><i class="fa fa-save">&nbsp;</i>Request Pembayaran</button>
		    	</center>
				 </div>
			</div>
		</form>		   
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'purchase_order_payment/SaveRequest';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
