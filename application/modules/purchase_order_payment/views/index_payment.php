...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			if($record->status == '2' && $record->approve_bayar == '1' ){?>
				<a class="btn btn-info btn-sm" href="<?= base_url('/purchase_order_payment/edit/'.$record->no_po.'/'.$record->id_data) ?>" title="Create Pembayaran" ><i class="fa fa-plus"></i></a>
