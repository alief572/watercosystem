...
{
	//Permission
	protected $viewPermission 	= 'Inventory_3.View';
	protected $addPermission  	= 'Inventory_3.Add';
	protected $managePermission = 'Inventory_3.Manage';
	protected $deletePermission = 'Inventory_3.Delete';
