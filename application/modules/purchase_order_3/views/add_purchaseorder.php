                       ...
                       $key++;
                          ...
                          echo "<tr>
								...
								<td><input type='text' class='form-control input-sm' id='dt_pr_".$key."' name='dt[".$key."][pr]' value='".$value->qty."' readonly ></td>
                              	...
                              	<td hidden><input type='text' class='form-control input-sm autoNumeric' id='dt_diskon_".$key."' name='dt[".$key."][diskon]' onkeyup='HitAmmount(".$key.")'></td>
