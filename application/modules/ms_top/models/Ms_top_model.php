 ...
 *
 * This is model class for table "ms_top_planning"
 */

class Ms_top_model extends BF_Model
{
    /**
     * @var string  User Table Name
     */
    protected $table_name = 'ms_top_planning';
    protected $key        = 'id';
