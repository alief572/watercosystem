...
class Stock_material_multi extends Admin_Controller
{
	//Permission
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'stock_material_multi/Inventory_4_model',
			'stock_material_multi/Serverside_model',
	...
	public function GudangDisplay()
	{
		...
		$this->template->set('results', $data);
		$this->template->title('Stock Gudang Display');
		$this->template->render('gudang_display');
		// $this->template->render('gudang');
	}

	public function GudangExdisplay()
	{
		$id_gudang = '3';
		$this->auth->restrict($this->viewPermission);
		$session = $this->session->userdata('app_session');
		...
		$this->template->set('results', $data);
		$this->template->title('Stock Gudang Exdisplay');
		$this->template->render('gudang_exdisplay');
		// $this->template->render('gudang');
	}

	public function GudangRetur()
	{
		$id_gudang = '4';
		$this->auth->restrict($this->viewPermission);
		$session = $this->session->userdata('app_session');
		...
		$this->template->set('results', $data);
		$this->template->title('Stock Gudang Retur');
		$this->template->render('gudang_retur');
		// $this->template->render('gudang');
	}
	...
	public function GudangKonsinyasi()
	{
		$this->auth->restrict($this->viewPermission);
		$session = $this->session->userdata('app_session');
		$this->template->page_icon('fa fa-users');
		...
		$this->template->set('results', $data);
		$this->template->title('Stock Gudang Konsinyasi');
		$this->template->render('gudang_konsinyasi');
		// $this->template->render('gudang');
	}
}
