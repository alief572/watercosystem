...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
            ...
            <th>Qty Transaksi</th>
            <th>Stok Awal Qty</th>
            <th>Stok Akhir Qty </th>
            <th>Stok Awal Booking</th>
            <th>Stok Akhir Booking</th>
            <th>Stok Awal Avl</th>
            <th>Stok Akhir Avl</th>
           	</tr>
		</thead>
		...
		<tr>
			...
			<td><?= ucfirst($record->transaksi) ?></td>
            <td><?= $record->nama ?></td>
            <td><?= $record->qty_transaksi ?></td>
            <td><?= $record->qty ?></td>
            <td><?= $record->qty_akhir ?></td>
            <td><?= $record->qty_book ?></td>
            <td><?= $record->qty_book_akhir ?></td>
            <td><?= $record->qty_free ?></td>
            <td><?= $record->qty_free_akhir ?></td>
		</tr>
		<?php 	 }
				}
		 ?>
