...
<div class="box">
		...
		<!--<form method="post" action="<?= base_url() ?>reports/tampilkan_penerimaan" autocomplete="off">
				<div class="row">
					<div class="col-sm-10">
						<div class="col-sm-2">
		...
		<thead>
					<tr class='bg-blue'>
						...
						<th width='7%'>Stock</th>
						<th width='7%'>Nilai Costbook</th>
						<th width='7%'>Total Nilai </th>
		...
		<?php if(empty($results)){
			...
			$numb=0; foreach($results AS $record){ $numb++; 
			   ...
			   $total  += $record->nilai_costbook*$record->qty;
			   
			   $totalformat  = number_format($total);
			   
			   $totalstok += $record->qty;
		...
		<tr>
			...
			<td><?= $record->qty ?></td>
			<td><?= $record->nilai_costbook?></td>
			<td><?= $record->nilai_costbook*$record->qty?></td>
		...
		<?php } }  ?>
				...
				<tfoot>
					<tr>
						...
						<th width='7%'></th>
						<th width='7%'></th>
						<th width='7%'><?= number_format($totalstok) ?></th>
						<th width='7%'></th>
						<th width='7%'><?= number_format($total) ?></th>		
...
<script type="text/javascript">
	  ...
	  $(document).ready(function() {
			...
			lengthMenu:[1000,2000,3000,10000]			
	        } );
        } );
