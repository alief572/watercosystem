...
<div class="box">
			...
			<form method="post" action="<?= base_url() ?>reports/tampilkan_jurnal_invoice" autocomplete="off">
				<div class="row">
					<div class="col-sm-10">
						<div class="col-sm-2">
	...
	<div class="box-body">
		...
		<?php if(empty($results)){
			...
			$numb=0; foreach($results AS $record){ $numb++; 
			   ...
			   $total  += $record->nilai_invoice;
			   $totaldpp  += $record->grand_total;
			   
			  $totalformat  = number_format($total,2);
			  $totaldppformat  = number_format($totaldpp,2);
