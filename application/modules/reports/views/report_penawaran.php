	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW AND $record->status != '4') : ?>
				<a class="btn btn-info btn-sm" href="<?= base_url('/wt_penawaran/printpenawaran/'.$record->no_penawaran) ?>" target="_blank" title="Print" data-no_inquiry="<?=$record->no_penawaran?>"><i class="fa fa-print"></i>
				</a>
			<?php endif; ?>
