...
class Pricelist_f extends Admin_Controller
{
	//Permission
	protected $viewPermission 	= 'Pricelist_f.View';
	protected $addPermission  	= 'Pricelist_f.Add';
	protected $managePermission = 'Pricelist_f.Manage';
	protected $deletePermission = 'Pricelist_f.Delete';
	...
	public function index()
	{
		...
		$deleted = '0';
		$data = $this->Pricelist_f_model->get_data('tr_inquiry');
