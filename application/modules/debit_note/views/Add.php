    ...
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8" hidden>
				<input type="text" class="form-control" id="no_pr"  required name="no_pr" readonly placeholder="id dn">
			</div>
			<div class="col-md-8">
				<input type="text" class="form-control" id="no_surat"  required name="no_surat" readonly placeholder="No.DN">
			</div>
		</div>
		</div>
		<div class="col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select id="id_customer" name="id_customer" class="form-control input-md chosen-select select" required>
                            <option value="">--Pilih--</option>
                                <?php foreach ($results['customers'] as $customers){?>
                            <option value="<?= $customers->id_customer.'|'.$customers->name_customer?>"><?= strtoupper(strtolower($customers->name_customer))?></option>
                                <?php } ?>
                        </select>
                    </div>
                </div>
		...
		<div class="form-group row" >
			...
			<tr>
				...
				<th width='10%' align='right'><input type='text' class='form-control maskMoney' id='totalharga' required name='totalharga' readonly></th>
				<th width='5%'></th>
			</tr>
			</tfoot>
			</table>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'debit_note/SaveNew';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
