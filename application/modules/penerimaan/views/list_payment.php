	...
	<div class="box box-primary">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				...
				<button class='btn btn-sm btn-success print' title='Print' data-inv='<?=$record->kd_pembayaran?>'><i class='fa fa-print'></i></button>
...
<script>
	...
	$(document).on('click', '.print', function(e){
		...
		window.open(base_url + active_controller+'print_penerimaan/'+invoice);
	});	
