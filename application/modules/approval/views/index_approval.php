<?php
    $ENABLE_ADD     = has_permission('Approval_Direktur.Add');
    $ENABLE_MANAGE  = has_permission('Approval_Direktur.Manage');
    $ENABLE_VIEW    = has_permission('Approval_Direktur.View');
    $ENABLE_DELETE  = has_permission('Approval_Direktur.Delete');
...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-warning btn-sm" href="<?= base_url('/wt_penawaran/prosesapproval/'.$record->no_penawaran) ?>" title="Ajukan approval"><i class="fa fa-mail-forward"></i>
				</a>
			<?php endif; ?>
