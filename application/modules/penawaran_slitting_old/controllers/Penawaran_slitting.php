...
class Penawaran_slitting extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'Penawaran_slitting/Inventory_4_model',
	...
	function LockDetail()
	{
		...
		$no_inquery = $crcl[0]->no_inquiry;
		$dtcrcl = $this->db->query("SELECT a.*, b.nama as namainven, b.hardness as hardness FROM dt_inquery_transaksi as a INNER JOIN ms_inventory_category3 as b ON a.id_category3 = b.id_category3 WHERE no_inquery = '$no_inquery'  ")->result();
		$material = $this->db->query("SELECT a.*, b.nama as alloy, c.nm_bentuk as bentuk FROM ms_inventory_category3 as a INNER JOIN ms_inventory_category2 as b ON a.id_category2 = b.id_category2 INNER JOIN ms_bentuk as c ON a.id_bentuk = c.id_bentuk WHERE a.deleted = '0' AND a.id_category3 = '$idmaterial' ")->result();
		echo "
