...
<tr>
	...
	<td nowrap colspan=2>Tanggal : <?=tgl_indo($data->tgl_doc)?></td>
</tr>
<tr>
	<th colspan=6><br /></th>
</tr>
...
<?php
$mengajukan=$this->db->query("SELECT a.ttd,b.name FROM users a join employees b on a.employee_id=b.id WHERE username='".$data->created_by."'")->row();
...
<tr height=120>
	...
	<u>&nbsp; &nbsp; <?=(($mengajukan)?$mengajukan->name:' &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp; ')?> &nbsp; &nbsp; </u><br><?=tgl_indo($data->created_on);?></td>
	<td colspan=2 align=center nowrap valign="bottom">
