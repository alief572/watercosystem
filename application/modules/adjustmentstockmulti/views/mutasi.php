...
<div class="box">
	<!-- /.box-header -->
		<form method="post" action="<?= base_url() ?>adjustmentstockmulti/index_mutasi" autocomplete="off">
          ...
          <?php } ?>
					   ...
					   <div class="col-sm-5">
							<div class="form-group">
								<br>
								<label> &nbsp;</label><br>
								<input type="submit" name="mutasi" value="Mutasi Gudang" class="btn btn-primary"> &nbsp;
							</div>
						</div>
    </div>
