    ...
    <div class="box-body">
		...
		<div class="col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    ...
                    <?php } else{ ?>
                    <input type='text' class='form-control' value="<?= $hutang->kurs  ?>" id='nominal_kurs'  required name='nominal_kurs'  placeholder='Nominal Kurs'> 
                    <?php }?>
                </div>
		    </div>
		    </div>
		...
		<div class="col-sm-12">
			...
			<div class="form-group row">
				...
				<div class="col-md-8"> 
				<input type="date" class="form-control" id="tanggal_bayar" value="<?= date('Y-m-d') ?>" onkeyup required name="tanggal_bayar" readonly >
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
				<div class="form-group row">
					<div class="col-md-4">
						<label for="customer">Total Hutang</label>
					</div>
					<div class="col-md-8">
                    <input type="input" class="form-control" id="total_ap" value="<?= number_format($hutang->hutang_kurs) ?>" onkeyup required name="total_ap" readonly >
					</div>
				</div>
			</div>
		</div> 
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
				<div class="form-group row">
					<div class="col-md-4">
                    <label for="id_customer">Total Bayar</label>
					</div>
					<div class="col-md-8">
                    <input type="input" class="form-control" id="total_bayar"  onblur="separator()" required name="total_bayar"  >	
					</div>
				</div>
			</div>
		</div> 
...
<script type="text/javascript">
	...
	$('#simpan-com').click(function(e){
			...
			var data, xhr;
				...
				if(bank == '' || bank == null){
					swal("Warning", "Bank Tidak Boleh Kosong :)", "error");
					return false;
					}
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'purchase_order_payment/SavePembayaran';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
