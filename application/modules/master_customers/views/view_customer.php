							...
							<div class="col-sm-6">
								...
								<div class="form-group row">
									<div class="col-md-6">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="name_customer" value='<?= html_escape($cus->name_customer) ?>' required name="name_customer" placeholder="Nama Customer">
									</div>
								</div>
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="email" required name="email" value='<?= $cus->email ?>' placeholder="email@domain.adress">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-6">
