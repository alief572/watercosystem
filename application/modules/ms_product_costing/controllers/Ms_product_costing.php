...
class Ms_product_costing extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'ms_product_costing/Ms_product_costing_model',
	...
	public function excel_calculation()
	{
		$this->auth->restrict($this->viewPermission);
		$result = $this->Ms_product_costing_model->get_data_pricelist();

		$this->load->view('excel_calculation', $result);
	}
